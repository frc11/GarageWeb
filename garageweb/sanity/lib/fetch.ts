...
import { CARS_QUERY, FEATURED_CARS_QUERY, CAR_BY_SLUG_QUERY, OFFER_CARS_QUERY, ALL_OFFERS_QUERY, BRANDS_QUERY, STOCK_BRANDS_QUERY, AVAILABLE_BRANDS_QUERY, FEATURED_VIDEO_QUERY } from "./queries";
...
export async function getFeaturedVideo(): Promise<string | null> {
    const data = await client.fetch(FEATURED_VIDEO_QUERY);
